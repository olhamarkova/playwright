...
test.describe("Buttons Page Tests", () => {
  test.beforeEach(async ({ buttonPage }) => {
    ...
    await buttonPage.validateHeading(headings.buttons);
  });
